...
{
    public partial class FrmKombinationsfeld : Form
    {
        public FrmKombinationsfeld()
        {
            InitializeComponent();
        }

        private void CmbWerkzeug1_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void FrmKombinationsfeld_Load(object sender, EventArgs e)
        {
