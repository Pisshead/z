...
namespace GenerischeTypen
{
    public partial class Form1 : Form
    {
        ...
        private void CmdListString_Click(object sender, EventArgs e)
        {
            ...
            LstAusgabe.Items.Add("Schweiz an Position: " +
                li.IndexOf("Schweiz"));
            LstAusgabe.Items.Add("Estland an Position: " +
                li.IndexOf("Estland"));
        ...
        private void CmdListLand_Click(object sender, EventArgs e)
        {
            ...
            LstAusgabe.Items.Add("Schweiz/Bern an Position: " +
                li.IndexOf(new Land("Schweiz", "Bern")));
            LstAusgabe.Items.Add("Estland/Tallinn an Position: " +
